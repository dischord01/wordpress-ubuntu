...
# WP Plugins
############
# works well for digitalocean fixed ip, not AWS EIP
WP_URL=$(hostname  -I | cut -f1 -d' ')
WP_BLOG_TITLE=' '
WP_BOSS=`pwgen -c -n -1 12`
WP_ADMIN_PASSWORD=`pwgen -c -n -1 12`
WP_EMAIL=brad.sollar@arcwaveusa.com
